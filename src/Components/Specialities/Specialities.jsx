...
const Specialities = () => {
  ...
  const specialitiesData = [
    ...
    },
    {
      ...
      linkTo: '/urology',
      title: 'Urology',
      description: 'Specialised & advanced treatment for Anorectal Diseases Surgical treatment for in men and women',
    },
    {
      imgSrc: Speciality6,
      linkTo: '/vascular',
      title: 'Vascular',
      description: 'Surgical subspecialty that focuses on the vascular system- arteries, veins and lymphatic...',
    },
  ];

  const displayedSpecialities = showAllSpecialities
    ? specialitiesData
    : specialitiesData.slice (0, 3);
  ...
  return (
    ...
    >
      <Container className="special_container" style={{width: '90rem'}}>
        <Row>
